...
public class ValidateSuccessDialog extends DialogFragment {
    private CloseClickListener closeClickListener;

    public ValidateSuccessDialog() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView.setImageResource(R.mipmap.success_check);
